...
namespace kuku
{
    ...
    */
    //Sumit: using table_size_type = location_type;
    using table_size_type = std::uint64_t;
    ...
    */
    //Sumit constexpr table_size_type max_table_size = table_size_type(1) << 30;
    constexpr table_size_type max_table_size = table_size_type(1) << 32;
