...
typedef struct [[gnu::packed]]{
    ...
    uint64_t C_HASH_KEY[2]; // Instead of storing the full tag, only storing the 128-bit cuckoo hash key, generated by issuing SHA256 hash on the tag and then convert it to 128-bit key
